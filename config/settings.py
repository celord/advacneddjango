...
#SECRET_KEY = '&@18daf(gn4$!@ypiuxi(vyq3vjz7cg8*cg*i-!3%1gwnigr*q'
...
TEMPLATES = [
    {
        ...
        #'DIRS': [str(BASE_DIR.joinpath('templates'))], #op1
        'DIRS': ['templates',BASE_DIR], #op2
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#STATIC_ROOT = ['staticfiles', BASE_DIR]
